...
function activate_sharify()
{
  ...
  add_option('display_button_facebook'	, 1);
	add_option('display_button_linkedin'	, 0);
	add_option('display_button_twitter'		, 1);
	add_option('display_button_email'		, 0);
	add_option('display_button_reddit'		, 0);
	...
	add_option('sharify_linkedin_btn_size'	, 0);
	add_option('sharify_email_btn_size'		, 0);
	add_option('sharify_vk_btn_size'		, 0);
	add_option('sharify_skype_btn_size'		, 0);
	add_option('sharify_use_gfont'			, 0);
